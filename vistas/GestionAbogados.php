...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php?page=GestionAbogados&abogado=<?php echo $id_AbogadoSystem; ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        <li class="nav-item active">
          <a class="navbar-brand" href="index.php?page=CrearAbogado&abogado=<?php echo $id_AbogadoSystem; ?>">Ingresar Abogado</a>
        </li>
        <li class="nav-item active">
          <a class="navbar-brand" href="index.php?page=AbogadosInactivos&abogado=<?php echo $id_AbogadoSystem; ?>">Abogados Inactivos</a>
        </li>
      </ul>
      <a class="navbar-brand" href="index.php?page=AbogadoAdmin&abogado=<?php echo $id_AbogadoSystem; ?>">Atras</a>
    </div>
  </nav>
  ...
  <div class="container-fluid">
    ...
    <form class="form-inline mt-4" method="post">
      ...
      <input type="text" class="form-control mb-2 mr-sm-2 col-lg-10 col-sm-9 col-md-10" id="buscar" name="Valor_Buscar" placeholder="Cedula...">
    ...
    <div class="row text-center mt-3 d-flex justify-content-around flex-wrap flex-row">
      ...
      ?>
        <a class=" col-2 nav-item rounded border border-dark ml-2 mr-2 mt-2" href="index.php?page=Acciones_Abogados&id=<?php echo $value["ID_ABOGADO"]; ?>&abogado=<?php echo $id_AbogadoSystem; ?> " style="text-transform: none; color: black">
