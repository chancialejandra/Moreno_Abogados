...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
    <a class="navbar-brand" href="index.php?page=Abogado&abogado=<?php echo $id_AbogadoSystem; ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item active">
          <a class="navbar-brand" href="index.php?page=ListaClientesAdmin&abogado=<?php echo $id_AbogadoSystem; ?>">Clientes</a>
        </li>
        <li class="nav-item active">
  ...
  <div class="container-fluid">
    ...
    <form class="form-inline mt-4" method="post">
      ...
      <input type="text" class="form-control mb-2 mr-sm-2 col-lg-10 col-sm-9 col-md-10" id="buscar" name="Valor_Buscar" placeholder="Radicado, Abogado...">
    ...
    <div class="row mb-2 py-2 text-center navbar-dark bg-dark text-uppercase align-items-center fs-6" style=" color: white ">
      <div class="col-2">
        Radicado
      </div>
      <div class="col-2 ">
            ...
            <div class="row">
              <div class="col">
                <a href="index.php?page=Litigio&id_L=<?php echo $value["ID_LITIGIO"]; ?>&abogado=<?php echo $id_AbogadoSystem; ?>">
                  <img src="IMG/open-folder-with-document.png" class="img-fluid" width="25%">
                </a>
              </div>
            </div>
          </div>
